...
<div class="row">
	<aside class="col-md-3">
		...
		<br>
		<a class="btn btn-light btn-block" href="#"> <i class="fa fa-power-off"></i> <span class="text"></span> </a> 
		<!--   SIDEBAR .//END   -->
	</aside>
	@if (count($orders) == 0)
	<div>
	...
	<main class="col-md-9">
		...
		<header class="card-header">
			<strong class="d-inline-block mr-3">Order ID: {{$order[0]->order_number}}</strong>
		...
		<table class="table table-hover">
			...
			<tr>
				...
				<td class="align-middle"> 
					...
					<p class="price text-muted mb-0">{{number_format($detail->price, 0, '', '.')}} ₫ </p>
					<p>SL: {{$detail->quantity}} </p>
				</td>
				<td class="align-middle">{{number_format($detail->total, 0, '', '.')}} ₫</td>
				<td class="align-middle" width="250"> <a href="#" class="btn btn-outline-primary">Track order</a> <a href="#" class="btn btn-light"> Details </a> </td>
			</tr>
			@endforeach
		</table>
